...
var LocationService = /** @class */ (function () {
    ...
    LocationService.prototype.findAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.locationRepository.find()];
    ...
    LocationService.prototype.findOne = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.locationRepository.findOneBy({ id: id })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        _a.label = 3;
                    case 3: return [2 /*return*/, location];
                }
            });
        });
    };
    LocationService.prototype.remove = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.locationRepository["delete"](id)];
                    case 1:
                        del = _a.sent();
